...
<html lang="en">
   ...
   <body>
      <div id="progress"></div>
      <!-- Navigation -->
      <nav class="navbar mnav navbar-expand-lg navbar-white static-top" style="background-color: #b7a1ad;padding:20px;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
         <div class="container" style="font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
            <a style="margin-left:0%;padding-left:0px" target="_blank" class="navbar-brand" href="https://www.nub.ac.bd/">
               <!-- <h3 class="mh3">BMSCE</h3> -->
               <img src="images/logo_nub.png" alt="">
            </a>
         ...
         <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
               ...
               <tr>
                  ...
                  <td class="td1">
                     <input type="text" name="USN" autocomplete="off" placeholder="Student ID" required />
                  </td>
               </tr>
               <tr>
                  <td>
                  ...
                  <td class="td1">
                     <input type="email" name="mail" autocomplete="off" placeholder="nub@gmail.com" required />
                  </td>
               </tr>
               <tr>
                  <td>
                  ...
                  <td class="td1">
                     <select name="dept" class="select1" autocomplete="off" placeholder="computer science" required>
                        ...
                        <option name="s2"> Textile Engineering</option>
                        <option name="s3"> Electrical & Electronics Engineering </option>
                        <option name="s4"> BBA - Bachelor of Business Administration </option>
                        <option name="s5"> Bangla Department </option>
                        <option name="s6"> English Department </option>
                        <option name="s7"> Pharmacy Department </option>
                        <option name="s8"> LLB - Bachelor of Law </option>
                     </select>
                  </td>
               </tr>
               <tr>
                  ...
                  <td class="td1">
                     <select name="sem" autocomplete="off" class="select12" placeholder="" required>
                        <option name="s1" value="" selected> Select Your Semester </option>
                        ...
                        <option name="s9"> 9 </option>
                        <option name="s10"> 10 </option>
                        <option name="s11"> 11 </option>
                        <option name="s12"> 12 </option>
                     </select>
                  </td>
               </tr>
               <tr>
