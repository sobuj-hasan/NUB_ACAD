...
<head>
    ...
    <!--Custom Favicon -->
    <link rel="icon" type="" sizes="64x64" href="../images/logo_nub.png">
...
<body>
    <div id="progress"></div>
    <nav class="navbar navbar-light" style="background-color: #b7a1ad;margin-bottom:2%;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        <a target="_blank" class="mh3 navbar-brand text-white" style="font-family:'Acme';font-size:30px" href="http://www.nub.ac.bd">
            <img src="../images/logo_nub.png" alt="Logo">
        </a>
